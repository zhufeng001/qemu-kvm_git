...
{
	// get l2 from phys_dirty
	// check phys_dirty is 0xff with l2
...
static inline int cpu_physical_memory_get_dirty(ram_addr_t addr,
                                                int dirty_flags)
{
	// check phys_dirty get by addr if contains dirty_flags
